...
The harness starts loopback servers on random local ports, opens persistent
HTTP/2 prior-knowledge and native TCP connections, performs warmup requests,
then measures each scenario for a fixed duration. It reports:
